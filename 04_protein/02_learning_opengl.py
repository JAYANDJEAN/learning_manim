...
class OpenGLSurface(OpenGLMobject):
    ...
    def __init__(self, uv_func=None, u_range=None, v_range=None,
                 resolution=None, axes=None, color=GREY, colorscale=None, colorscale_axis=2,
                 opacity=1.0, gloss=0.3, shadow=0.4,
                 prefered_creation_axis=1, epsilon=1e-5, render_primitive=moderngl.TRIANGLES,
                 depth_test=True, shader_folder=None, **kwargs,
                 ):
    ...
    def init_points(self):
        ...
        point_lists = []
        # 为了后续能够计算曲面的法向量，这些点除了基本的 u,vu, vu,v 对应的点，
        # 还会通过对 uuu 和 vvv 的微小扰动（epsilon）来生成附近的点。
